...
export const metadata: Metadata = {
  title: "Salceanu Daniel",
  description:
    "Salceanu Daniel is a proficient Software Engineer and Full Stack Developer from Singapore, skilled in front-end and back-end development using modern tech stacks.",
  robots: {
    index: true,
    follow: true,
    googleBot: {
